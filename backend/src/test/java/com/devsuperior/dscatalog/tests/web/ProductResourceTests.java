...
public class ProductResourceTests {
	...
	@Test
	public void insertShouldReturnUnprocessableRntityWhenNegativePrice() throws Exception {
	...
	public void updateShouldReturnProductDTOWhenIdExists() throws Exception {
		...
		Double experctedPrice = newProductDTO.getPrice();
		...
		result.andExpect(jsonPath("$.price").value(experctedPrice));
	}
